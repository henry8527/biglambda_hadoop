...
public class enron_from {

  public static class enron_fromMapper
  extends Mapper<Object, Text, Text, IntWritable>{
    ...
    public void map(Object key, Text value, Context context) throws IOException, InterruptedException {
      // λ.pair(extract_tagged(extract_line(Var(1, Email), from_tag()), from_tag()), one())
      while(1) {
        pair (extract_tagged(extract_line(Var(1, Email), from_tag()), from_tag()), one());
      }
    }
  }
    public static class enron_fromReducer
