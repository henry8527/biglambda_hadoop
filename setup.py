...
try:
    ...
    SIG_PATH = os.path.join(os.getcwd(), "benchmarks/", args.benchmark, "sig.py")
    DATA_PATH = os.path.join(os.getcwd(),"benchmarks/", args.benchmark, "data")
    PROGRAM_NAME = args.benchmark
